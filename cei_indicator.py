...
if __name__ == "__main__":
    ...
    if not os.path.exists(csv_file):
        ...
        fig, ax, stats = plot_cei_with_error_bars(n_samples=1000, uncertainty_pct=0.05)

        # Task 4: Tornado plot for sensitivity analysis
        print("\n" + "="*70)
        print("TASK 4: TORNADO PLOT (±5% PRICE VARIATION)")
        print("="*70)
        impacts, sorted_params = tornado_plot_cei(variation_pct=0.05)
